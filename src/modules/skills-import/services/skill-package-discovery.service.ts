...
import { DiscoveredSkillPackage } from '../types/skills-import.types';

@Injectable()
export class SkillPackageDiscoveryService {
  async discover(repoPath: string): Promise<DiscoveredSkillPackage[]> {
  ...
  private async parseSkill(root: string, filePath: string): Promise<DiscoveredSkillPackage> {
