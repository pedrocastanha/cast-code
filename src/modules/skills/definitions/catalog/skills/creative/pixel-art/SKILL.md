...
```python
import sys
sys.path.insert(0, "/home/teknium/.cast/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.cast/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Cast installs package this)
