...
version: 1.0.0
author: Cast Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
Each template includes a **Cast Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Cast notes -->
