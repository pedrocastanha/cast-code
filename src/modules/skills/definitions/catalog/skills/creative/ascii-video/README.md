...
Built for [Cast Agent](https://github.com/NousResearch/cast-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/cast-agent/skills/creative/ascii-video`](https://github.com/NousResearch/cast-agent/tree/main/skills/creative/ascii-video) via PR.
