...
```bash
python3 -m pyfiglet "CAST" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CAST&font=Slant" | boxes -d stone
```
