...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Cast Agent
license: MIT
...
Also apply this skill to **your own** output when writing user-facing prose — release notes, PR descriptions, documentation, long-form explanations, summaries. Cast's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in Cast
