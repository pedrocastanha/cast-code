...
|--------|----------|--------|
| Metadata namespace | `openclaw` | `cast` |
...
| File operations | Bash commands | Cast file tools (write_file, read_file) |
...
Reference files can be overwritten directly (they're unchanged from upstream). SKILL.md must be manually merged since it contains Cast-specific adaptations.
