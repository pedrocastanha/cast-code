...
Control the user's Spotify account via the Cast Spotify toolset (7 tools). Setup guide: https://cast-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `cast auth spotify` again.
