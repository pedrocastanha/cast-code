...
4. Name the token (e.g., "Cast Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.cast/.env`:
...
```bash
CANVAS="python $CAST_HOME/skills/productivity/canvas/scripts/canvas_api.py"
