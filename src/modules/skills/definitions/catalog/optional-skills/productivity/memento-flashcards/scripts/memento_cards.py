...
Data file: $CAST_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CAST_HOME = Path(os.environ.get("CAST_HOME", Path.home() / ".cast"))
DATA_DIR = _CAST_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
