...
```
~/.cast/skills/productivity/memento-flashcards/data/cards.json
```
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py add \
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py due
```

This returns a JSON array of cards where `next_review_at <= now`. If a collection filter is needed:

```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py due --collection "History"
```
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py rate \
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/youtube_quiz.py fetch VIDEO_ID
```
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py add-quiz \
  --video-id "VIDEO_ID" \
...
**Export:**
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py export \
...
**Import:**
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py import \
  --file ~/flashcards.csv \
  --collection "Imported"
```
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py stats
```
...
```bash
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py stats
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py add --question "Capital of France?" --answer "Paris" --collection "General"
python3 ~/.cast/skills/productivity/memento-flashcards/scripts/memento_cards.py due
```
