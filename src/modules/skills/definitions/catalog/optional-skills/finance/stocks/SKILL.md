...
version: 0.1.0
author: Mibay (Mibayy), Cast Agent
license: MIT
...
```
SCRIPT=~/.cast/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.cast/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
