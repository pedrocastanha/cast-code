#!/usr/bin/env python3
"""
stocks_client.py - Stock market data CLI tool for the Cast Agent project.
...
USER_AGENT = "Mozilla/5.0 (compatible; CastAgent/1.0)"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="stocks_client",
        description="Stock & crypto market data CLI — Cast Agent",
