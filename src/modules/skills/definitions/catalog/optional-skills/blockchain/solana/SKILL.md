...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Cast Agent
license: MIT
...
Helper script path: ~/.cast/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.cast/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.cast/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.cast/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.cast/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.cast/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.cast/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
