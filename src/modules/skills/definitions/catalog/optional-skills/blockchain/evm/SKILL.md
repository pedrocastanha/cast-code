...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Cast Agent
license: MIT
...
Helper script path: `~/.cast/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.cast/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.cast/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.cast/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
