#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Cast Agent
-------------------------------------
...
def _resolve_user(user: Optional[str]) -> str:
    ...
    sys.exit(
        ...
        f"{DEFAULT_USER_ENV} in your environment or ~/.cast/.env."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Cast Agent")
