...
def _state_dir() -> Path:
    ...
    # Default: $CAST_HOME/watcher-state/, falling back to ~/.cast/watcher-state/.
    cast_home = os.environ.get("CAST_HOME") or str(Path.home() / ".cast")
    return Path(cast_home) / "watcher-state"
