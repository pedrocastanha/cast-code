Analise profundamente o projeto "cast-code" localizado em /home/pedro-castanheira/Desktop/Projetos Pessoais/cast-code.
...
2. **Analise os módulos**
   - **modules** (src/modules): Funcionalidade específica do domínio
   - **common** (src/common): Common - Código compartilhado
